        ...
        <div class="col-md-6 wthree_agile_login">
            <ul>
                ...
                @if (Auth::check())
                    ...
                    <li >
                        <a class="login"  href= "{{route('dashboard')}}">Dashboard</a>
                    </li>
                    @endif
                    <li>
                ...
                @else
                <li>
                    <a class="login" class="login"   data-target="#myModal4" href= "{{route('login')}}">login</a>
                </li>
                <li >
                    <a class="login reg" class="login reg"  href= "{{route('register')}}">register</a>
                </li>
                @endif
                ...
                <ul>
                    ...
                    <li class="news-twitter">
                        <a href="https://twitter.com/w3layouts" class="twitter-follow-button" data-show-count="false">Follow
                            @w3layouts</a>
                        <script async src="{{asset('//platform.twitter.com/widgets.js')}}" charset="utf-8"></script>
                    </li>
                    <li>
        ...
        <div class="footer-grids w3-agileits">
            ...
            <div class="col-md-2 footer-grid">
                ...
                <div class="footer-grid1">
                    <div class="footer-grid1-left">
                        <a href="single.html"><img src="{{asset('/Templates/template_2/images/1.jpg')}}" alt=" " class="img-responsive"></a>
                    </div>
                ...
                <div class="footer-grid1">
                    <div class="footer-grid1-left">
                        <a href="single.html"><img src="{{asset('/Templates/template_2/images/2.jpg')}}" alt=" " class="img-responsive"></a>
                    </div>
                    <div class="footer-grid1-right">
                ...
                <div class="footer-grid1">
                    ...
                    <div class="footer-grid1-left">
                        <a href="single.html"><img src="{{asset('/Templates/template_2/images/4.jpg')}}" alt=" " class="img-responsive"></a>
                    </div>
                    <div class="footer-grid1-right">
                        <a href="single.html">eveniet ut molesti</a>
                ...
                <div class="footer-grid1">
                    <div class="footer-grid1-left">
                        <a href="single.html"><img src="{{asset('/Templates/template_2/images/3.jpg')}}" alt=" " class="img-responsive"></a>
                    </div>
                    <div class="footer-grid1-right">
                        <a href="single.html">earum rerum tenet</a>
            ...
            <div class="col-md-2 footer-grid">
                ...
                <div class="footer-grid-instagram">
                    <a href="single.html"><img src="{{asset('/Templates/template_2/images/m1.jpg')}}" alt=" " class="img-responsive"></a>
                </div>
                <div class="footer-grid-instagram">
                    <a href="single.html"><img src="{{asset('/Templates/template_2/images/m2.jpg')}}" alt=" " class="img-responsive"></a>
                </div>
                <div class="footer-grid-instagram">
                    <a href="single.html"><img src="{{asset('/Templates/template_2/images/m3.jpg')}}" alt=" " class="img-responsive"></a>
                </div>
                <div class="footer-grid-instagram">
                    <a href="single.html"><img src="{{asset('/Templates/template_2/images/m4.jpg')}}" alt=" " class="img-responsive"></a>
                </div>
                <div class="footer-grid-instagram">
                    <a href="single.html"><img src="{{asset('/Templates/template_2/images/m5.jpg')}}" alt=" " class="img-responsive"></a>
                </div>
                <div class="footer-grid-instagram">
                    <a href="single.html"><img src="{{asset('/Templates/template_2/images/m6.jpg')}}" alt=" " class="img-responsive"></a>
                </div>
