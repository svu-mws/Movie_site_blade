<!--/banner-section-->
<div id="demo-1" data-zs-src='["{{asset('Templates/template_2/images/2.jpg')}}", "{{asset('Templates/template_2/images/1.jpg')}}", "{{asset('Templates/template_2/images/3.jpg')}}","{{asset('Templates/template_2/images/4.jpg')}}"]' data-zs-overlay="dots">
            ...
            <div class="inner-header-agile">
                <nav class="navbar navbar-default">
                    <div class="navbar-header">
                        ...
                        <h1><a href="{{asset('index.html')}}"><span>M</span>ovies <span>P</span>ro</a></h1>
                    </div>
                    <!-- navbar-header -->
