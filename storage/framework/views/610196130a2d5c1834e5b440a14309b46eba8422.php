<!--/banner-section-->
<div id="demo-1" data-zs-src='["<?php echo e(asset('Templates/template_2/images/2.jpg')); ?>", "<?php echo e(asset('Templates/template_2/images/1.jpg')); ?>", "<?php echo e(asset('Templates/template_2/images/3.jpg')); ?>","<?php echo e(asset('Templates/template_2/images/4.jpg')); ?>"]' data-zs-overlay="dots">
            ...
            <div class="inner-header-agile">
                <nav class="navbar navbar-default">
                    <div class="navbar-header">
                        ...
                        <h1><a href="<?php echo e(asset('index.html')); ?>"><span>M</span>ovies <span>P</span>ro</a></h1>
                    </div>
                    <!-- navbar-header -->
...
<!--/banner-section-->
<!--//main-header-->
<?php /**PATH C:\Users\HERO\Desktop\F\movies1\resources\views/includes/navigation.blade.php ENDPATH**/ ?>