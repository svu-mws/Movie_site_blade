...
<head>
    ...
    <title><?php echo $__env->yieldContent('title','Laravle Blog Admin'); ?></title>
    <!-- Custom CSS -->
    <link href="<?php echo e(asset('admin/assets/libs/flot/css/float-chart.css')); ?>" rel="stylesheet">
    <!-- Custom CSS -->
    <link href="<?php echo e(asset('admin/assets/dist/css/style.min.css')); ?>" rel="stylesheet">
...
<body>
    ...
    <!--Wave Effects -->
    <script src="<?php echo e(asset('admin/assets/dist/js/waves.js')); ?>"></script>
    <!--Menu sidebar -->
    <script src="<?php echo e(asset('admin/assets/dist/js/sidebarmenu.js')); ?>"></script>
    <!--Custom JavaScript -->
    <script src="<?php echo e(asset('admin/assets/dist/js/custom.min.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('admin/assets/dist/js/pages/chart/chart-page-init.js')); ?>"></script>

</body>

</html>
<?php /**PATH C:\Users\HERO\Desktop\F\movies1\resources\views/layouts/admin.blade.php ENDPATH**/ ?>